...
|----------|-------------|-------------|--------|
| [api-design/dsh-sdk-wire-protocol-parity.md](api-design/dsh-sdk-wire-protocol-parity.md) | iteration:v0.1 (01+02) | DSH wire-protocol source-verified facts, the three corrected traps (inserted[].id receipt, skip-malformed-lines, stderr tail), Python-parity RunResult decisions incl. documented divergences | active |
